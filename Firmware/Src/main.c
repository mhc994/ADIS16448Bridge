...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SENSORS_3V3_EN_GPIO_Port, SENSORS_3V3_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : SENSORS_3V3_EN_Pin */
  GPIO_InitStruct.Pin = SENSORS_3V3_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SENSORS_3V3_EN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : ADIS_DRDY_Pin */
  GPIO_InitStruct.Pin = ADIS_DRDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ADIS_DRDY_GPIO_Port, &GPIO_InitStruct);
